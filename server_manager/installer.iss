...
begin
  ...
  begin
    ...
    // Speichern Sie die Pfade in der Konfigurationsdatei
      SetIniString('Paths', 'BackendPath', WelcomePage.Values[0], ExpandConstant('{app}\\config.ini'));
      SetIniString('Paths', 'FrontendPath', WelcomePage.Values[1], ExpandConstant('{app}\\config.ini'));
  end;
end; 